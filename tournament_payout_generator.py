...
class TournamentPayoutGenerator:
    ...
    def generate_tournament_payout_structure(self):
        ...
        print(f"${self.entry_fee}\t{self.player_count}\t4th\t${fourth_place_payout}")
        print(f"${self.entry_fee}\t{self.player_count}\t5th\t${fifth_place_payout}")
        print(f"${self.entry_fee}\t{self.player_count}\t6th\t${sixth_place_payout}")

        if player_count_32_47:
            print(f"${self.entry_fee}\t{self.player_count}\t7th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t8th\t${self.entry_fee}")

        elif player_count_48_63:
            print(f"${self.entry_fee}\t{self.player_count}\t7th\t${seventh_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t8th\t${eighth_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t9th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t10th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t11th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t12th\t${self.entry_fee}")

        elif player_count_64_128:
            print(f"${self.entry_fee}\t{self.player_count}\t7th\t${seventh_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t8th\t${eighth_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t9th\t${ninth_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t10th\t${tenth_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t11th\t${eleventh_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t12th\t${twelth_place_payout}")
            print(f"${self.entry_fee}\t{self.player_count}\t13th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t14th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t15th\t${self.entry_fee}")
            print(f"${self.entry_fee}\t{self.player_count}\t16th\t${self.entry_fee}")
